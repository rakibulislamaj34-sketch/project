<style>
    ...
    @media print {
        ...
        #posInvoicePrintout {
            ...
            top: 0;
            width: 80mm;
            /* Standard POS thermal printer width */
                        ...
                        <?php  
                          ...
                          foreach ($table as $key => $value) {
                           echo "
                            ...
                            <option value='$value->id'>Table No-$value->table_number</option>
...
<script>
    ...
    function printInvoice() {
        ...
        // Populating the items row by row
        cart.forEach(item => {
            const itemTotal = item.price * item.quantity;
            subtotal += itemTotal;
        ...
        // Set the current date/time string
